...
import { getBookingsByOwnerId, updateBookingStatus } from "@/actions/bookings";
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        setLoading(true);
        if (loggedInUser?.id) {
          const result = await getBookingsByOwnerId(loggedInUser.id);
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        {loading ? (
          ...
          <InfoMessage message="No bookings found for your properties." />
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
